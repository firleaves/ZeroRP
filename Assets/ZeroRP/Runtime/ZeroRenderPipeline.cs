...
namespace ZeroRP
{
    public class ZeroRenderPipeline : RenderPipeline
    {
        ...
        private ZeroRPRenderGraphRecorder m_ZeroRPRenderGraphRecorder = null; //渲染图记录器
        ...
        private void InitializeRenderGraph()
        {
            ...
            m_ZeroRPRenderGraphRecorder = new ZeroRPRenderGraphRecorder();
        ...
        private void CleanupRenderGraph()
        {
            ...
            m_ZeroRPRenderGraphRecorder = null;
...
;           return true;
        ...
        private void RecordAndExecuteRenderGraph(ScriptableRenderContext context, Camera camera, CommandBuffer cmd)
        {
            ...
            //开启录制时间线
            m_ZeroRPRenderGraphRecorder.RecordRenderGraph(m_RenderGraph, m_ContextContainer);
